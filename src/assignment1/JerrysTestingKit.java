...
public class JerrysTestingKit {
    ...
    public static TestGroup implementation = new TestGroup("Setup",
            ...
            new Test[] {
                    // Extract worker jobs.
                    new Test("assignment1.Archer Arrows Field", "Automatically fetches the arrows field of the archer class.", () -> {
                        // The archer should only declare one field, so this should be perfect.
                        // If this test fails, replace this code with
                        // archerArrowsField = assignment1.Archer.class.getDeclaredField("FIELD NAME");
                    ...
                    new Test("assignment1.Worker Jobs Field", "Automatically fetches the jobs completed field of the archer class.", () -> {
                        // If this test fails, replace this code with
                        // workerJobsField = assignment1.Worker.class.getDeclaredField("FIELD NAME");
                        // Replace the "FIELD NAME" with your own field name.
                        workerJobsField = Worker.class.getDeclaredFields()[0];
                        workerJobsField.setAccessible(true);
                    }),
                    new Test("assignment1.Tile Units Field", "Automatically fetches the units field for a tile. If this crashes, you do not have a field for assignment1.ListOfUnits.", () -> {
    ...
    public static TestGroup equalities = new TestGroup("Equalities",
            ...
            new Test[]{
                    new Test("Base Unit.equals()", "Units should compare their stats properly.", () -> {
                        ...
                        Unit unit1 = new Unit(dummyTile, 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                        Unit unit2 = new Unit(dummyTile, 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                    ...
                    new Test("Unit != Non-Unit", "Equals should automatically reject something that's not a unit.", () -> {
                        Unit unit1 = new Unit(new Tile(0, 0), 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                    ...
                    new Test("Unit.equals() spots HP difference", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Unit unit1 = new Unit(dummyTile, 20.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                        Unit unit2 = new Unit(dummyTile, 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                    ...
                    new Test("Unit.equals() spots position difference", () -> {
                        ...
                        Unit unit2 = new Unit(dummyTile2, 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                    ...
                    new Test("Unit.equals() insensitive to moving range difference",
                        ...
                        Unit unit2 = new Unit(dummyTile, 10.0, 2, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };
                    ...
                    new Test("Unit.equals() tolerates minor HP difference",
                        ...
                        Unit unit2 = new Unit(dummyTile, 10.0 + Math.sqrt(0.000999999), 2, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };

                        Test.assertEq(unit1, unit2);
                    }),
                    new Test("assignment1.Settler.equals()", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Settler settler1 = new Settler(dummyTile, 10.0, "assignment1.Test");
                        Settler settler2 = new Settler(dummyTile, 10.0, "assignment1.Test");

                        Test.assertEq(settler1, settler2);
                    }),
                    new Test("assignment1.Settler != Non-assignment1.Settler", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Settler settler = new Settler(dummyTile, 10.0, "assignment1.Test");
                        Worker worker = new Worker(dummyTile, 10.0, "assignment1.Test");

                        Test.assertNe(settler, worker);
                    }),
                    new Test("assignment1.Worker.equals()", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Worker worker1 = new Worker(dummyTile, 10.0, "assignment1.Test");
                        Worker worker2 = new Worker(dummyTile, 10.0, "assignment1.Test");

                        Test.assertEq(worker1, worker2);
                    }),
                    new Test("assignment1.Worker.equals() spots jobs performed difference.", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Worker worker1 = new Worker(dummyTile, 10.0, "assignment1.Test");
                    ...
                    new Test("assignment1.Worker != Non-assignment1.Worker", "This test requires assignment1.Worker.takeAction() to be implemented properly.", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Settler settler = new Settler(dummyTile, 10.0, "assignment1.Test");
                        Worker worker = new Worker(dummyTile, 10.0, "assignment1.Test");
                    ...
                    new Test("assignment1.Warrior.equals()", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Warrior warrior1 = new Warrior(dummyTile, 10.0, "assignment1.Test");
                        Warrior warrior2 = new Warrior(dummyTile, 10.0, "assignment1.Test");

                        Test.assertEq(warrior1, warrior2);
                    }),
                    new Test("assignment1.Warrior != Non-assignment1.Warrior", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Warrior warrior = new Warrior(dummyTile, 10.0, "assignment1.Test");
                        Worker worker = new Worker(dummyTile, 10.0, "assignment1.Test");

                        Test.assertNe(warrior, worker);
                    }),
                    new Test("assignment1.Archer.equals()", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Archer archer1 = new Archer(dummyTile, 10.0, "assignment1.Test");
                        Archer archer2 = new Archer(dummyTile, 10.0, "assignment1.Test");

                        Test.assertEq(archer1, archer2);
                    }),
                    new Test("assignment1.Archer.equals() spots arrows difference.", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Archer archer1 = new Archer(dummyTile, 10.0, "assignment1.Test");
                    ...
                    new Test("assignment1.Archer != Non-assignment1.Archer", () -> {
                        Tile dummyTile = new Tile(0, 0);
                        Archer archer = new Archer(dummyTile, 10.0, "assignment1.Test");
                        Worker worker = new Worker(dummyTile, 10.0, "assignment1.Test");
    ...
    public static TestGroup listOfUnits = new TestGroup("assignment1.ListOfUnits",
            "Various limit-testing on the assignment1.ListOfUnits class. " +
            ...
            new Test[]{
                    new Test("Constructor", "Verifies the default properties of a new assignment1.ListOfUnits", () -> {
                    ...
                    new Test("addUnit()", "List should handle adding a unit and update its size. A working getList() is required for this test.", () -> {
                        ...
                        Unit dummy = new Settler(new Tile(0, 0), 1.0, "assignment1.Test");
                    ...
                    new Test("Spam addUnit()", "A bunch of things should be able to be added to the list.", () -> {
                        ...
                        for (int i = 0; i < spamAddTestSize; i++) {
                            // assignment1.Settler is the simplest unit.
                            Unit newUnit = new Settler(dummyTile, 1.0, "assignment1.Test");
                    ...
                    new Test("getUnit()", "Indices should be in order of adding when there's no removals.", () -> {
                        ...
                        for (int i = 0; i < manipulateTestSize; i++) {
                            // assignment1.Settler is the simplest unit. Give it an index as the faction.
                    ...
                    new Test("getList() no nulls after removeUnit() and addUnit()", "The list should contain no nulls after removing then adding.", () -> {
                        ...
                        list.removeUnit(list.getUnit(3));
                        list.addUnit(new Settler(dummyTile, 1.0, "assignment1.Test"));
    ...
    public static TestGroup tile = new TestGroup("assignment1.Tile",
            "Basic functioning of tiles. " +
                    "Since a tile has a assignment1.ListOfUnits, passing the assignment1.ListOfUnits tests is a prerequisite for this group.",
            new Test[] {
                    ...
                    new Test("addUnit() to empty tile", "The unit should be in the tile's unit list, and ", () -> {
                        ...
                        Unit unit = new Settler(origin, 1.0, "assignment1.Test");
    ...
    public static TestGroup unit = new TestGroup("Base Unit",
            "Basic functioning of units. " +
                    ...
                    "Certain tests involve building city or improvements. Passing the assignment1.Tile tests is a prerequisite for this group.",
            new Test[] {
                    new Test("Constructor", "The constructor should properly initialise a unit's properties.", () -> {
                        Tile tile = new Tile(0, 0);
                        Unit unit1 = new Unit(tile, 10.0, 1, "assignment1.Test") {
                            @Override public void takeAction(Tile target) { }
                        };

                        Test.assertEq(unit1.getHP(), 10.0);
                        Test.assertEq(unit1.getFaction(), "assignment1.Test");
    ...
    public static TestGroup militaryUnit = new TestGroup("Base assignment1.MilitaryUnit",
            "Basic functioning of military units. " +
                    "Since assignment1.MilitaryUnit is a subclass of Unit, passing the Base Unit tests is a prerequisite for this group.",
            new Test[]{
    ...
    public static TestGroup settler = new TestGroup("assignment1.Settler",
            "Various functions of the settler. Since assignment1.Settler is a subclass of Unit, passing the Base Unit tests is a prerequisites for this group.",
            new Test[]{
    ...
    public static TestGroup worker = new TestGroup("assignment1.Worker",
            "Various functions of the worker. Since assignment1.Worker is a subclass of Unit, passing the Base Unit tests is a prerequisites for this group.",
            new Test[]{
    ...
    public static TestGroup archer = new TestGroup("assignment1.Archer",
            "Various functions of the archer. Since assignment1.Archer is a subclass of assignment1.MilitaryUnit, passing the assignment1.MilitaryUnit test is a prerequisite for this group.",
            new Test[]{
